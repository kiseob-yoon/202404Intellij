package com.ks._sb0411.problem;


import com.ks._sb0411.repository.AnswerRepository;
import com.ks._sb0411.repository.QuestionRepository;
...
//        model.addAttribute("questions", list);
    ...
    public String submit(@ModelAttribute("ansData") Answer ans) {
        log.info("응답자료 {}", ans);
        com.ks._sb0411.entity.Answer entity = com.ks._sb0411.entity.Answer.toEntity(ans);
