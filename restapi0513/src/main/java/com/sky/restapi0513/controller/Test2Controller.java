...
public class Test2Controller {
    ...
    @GetMapping("/testResponseBodyEntity")
    ...
    public ResponseEntity<TestRequestBodyDTO> testControllerRequestBody1(@RequestBody TestRequestBodyDTO testRequestBodyDTO){
        System.out.println(testRequestBodyDTO);
        return ResponseEntity.ok(testRequestBodyDTO);
    }

    @PostMapping("/testRequestBody")
    public TestRequestBodyDTO testControllerRequestBody2(@RequestBody TestRequestBodyDTO testRequestBodyDTO){
        System.out.println(testRequestBodyDTO);
